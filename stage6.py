...
def enter():
    ...
    server.background.select_map = 6
    server.background.image = load_image('image/map/map6.png')
    ...
    set_knight(3930, 6013) 
    
    with open('enemy_data.json','r') as f:
        enemy_list = json.load(f)
        crawlid_data = enemy_list['stage6']['crawlid']
        ...
        husk_data = enemy_list['stage6']['husk']
        for i in husk_data:
        ...
        vengefly_data = enemy_list['stage6']['vengefly']
