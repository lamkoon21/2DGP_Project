...
def enter():
    ...
    server.background.select_map = 4
    server.background.image = load_image('image/map/map4.png')
    ...
    with open('enemy_data.json','r') as f:
        ...
        crawlid_data = enemy_list['stage4']['crawlid']
        ...
        husk_data = enemy_list['stage4']['husk']
        for i in husk_data:
        ...
        vengefly_data = enemy_list['stage4']['vengefly']
